...
# How does it work?
1. Start process from shortcut
2. shortcut starts starcraft suspended
3. it loads the mod.dll into memory
3. it let's mod.dll attach itself to relevant funcitons
4. sc.exe is resumed
5. enoj sc.exe with extra features
